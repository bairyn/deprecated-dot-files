...
PREBAR='^i(/home/bob/dzen/icons/dzen_bitmaps/battery.xbm)' # caption (also icons are possible)
...
sleep $TIME_INT;
done | dzen2 -ta c -tw $W -y $Y -x $X -fg $FG -bg $BG -fn $FN -e 'onstart=lower,collapse;onstart=hide;sigusr1=togglehide;sigusr2=unhide'
