...
}" | dzen2 -ta c -sa r -l 5 -w $W -tw $W -x $X -fn $FN -fg $FG -bg $BG -e "button1=togglecollapse;button3=exit" -e 'onstart=lower,collapse;onstart=hide;sigusr1=togglehide;sigusr2=unhide'
